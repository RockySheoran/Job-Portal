  ...
  return (
    <div className='text-center'>
      <div className="headerContent flex gap-5 flex-col items-center">
        ...
        <p className='md:w-[50%] w-full ml-2'>Welcome to JobPortal – your ultimate platform to search and apply for jobs at your favorite companies. Unlock opportunities and connect with top employers today!</p>
        <div className="inputFild w-full sm:w-[55%] flex border border-gray-200 shadow-lg rounded-full items-center gap-4 mx-auto pl-3 ">
          <input type="text"  onChange={(e) => setQuery(e.target.value) }   placeholder='Find your dream job' className='outline-none    w-full  border-0' />
